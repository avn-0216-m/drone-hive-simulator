...
func _process(delta):
	...
	get_node("Composite/BackgroundTexture/Viewport/BackgroundCylinder/Camera").rotation_degrees = get_node("Composite/GameTexture/Viewport/Game/Camera").rotation_degrees

func _ready():
	get_node("DebugUI/Level/Respawn drone").connect(
		"respawn",
		get_node("Composite/GameTexture/Viewport/Game"),
		"respawn_drone"
		)
	get_node("DebugUI/Level/Add tasks").connect(
		"add_tasks",
		get_node("Composite/GameTexture/Viewport/Game/Level"),
	...
	get_node("DebugUI/Other/Random music").connect(
		"random_music",
		get_node("Composite/GameTexture/Viewport/Game/Music"),
		"change_music"
		)
